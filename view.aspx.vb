   ...
   Public Function IsAuthenticated(ByVal domain As String, ByVal username As String, ByVal pwd As String) As Boolean
    ...
    Protected Sub btn_login_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_login.Click
        ...
        oconn.Open()
                ...
                myCommand.CommandText = "Select corpID, Name, hosp, Unit, ward, rank, Employee_no, CONVERT(VARCHAR(15), papp, 106) As papp From Staff Where corpID = @username"
                ...
                myCommand1.CommandText = "Select role From normal_user Where corpid = @username"
